...
public class MyBatisDaoFactory extends DaoFactory {
   ...
   /**
    ...
    @Override
    public DaoRolPersona getDaoRolPersona() {
        return new MyBatisDAORolPersona(currentSession);
    }
    ...
    @Override  
    public DaoEgresadoEmpresa getDaoEgresadoEmpresa() {
        return new MyBatisDAOEgresadoEmpresa(currentSession);
    }
    ...
    @Override
    public DaoPagoAfiliacion getDaoPagoAfiliacion() {
        return new MyBatisDAOPagoAfiliacion(currentSession);
    }
