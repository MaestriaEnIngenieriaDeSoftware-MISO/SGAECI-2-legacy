...
public class ProcesarSolicitudAfiliacionBean implements Serializable{
    ...
    final String usuarioasignado = "Su usuario de ingreso asignado es: "+usuarioAs; // se informa al afiliado, el usuario asignado por el sistema
    final String passwordasignado = "Su contraseña de ingreso asignado es: "+passAs; // se informa al afiliado, la contraseña  asignado por el sistema
