...
public class EntradasForoTest {
    ...
    @Test
    public void registroPacienteTest() throws ExcepcionServiciosSAGECI{ 
        assertTrue(true);
        /*
    ...
    @Test
    public void consultarEntradaConIdInexistente() throws ExcepcionServiciosSAGECI{
        assertTrue(true);/*
        try{
    ...
    @Test
    public void deberiaConsultarTodasLasEntradasForo() throws ExcepcionServiciosSAGECI{
        assertTrue(true);/*
